...
var canariesResource = schema.GroupVersionResource{Group: "example.app", Version: "v1beta1", Resource: "canaries"}

var canariesKind = schema.GroupVersionKind{Group: "example.app", Version: "v1beta1", Kind: "Canary"}
