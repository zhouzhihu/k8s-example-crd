...
import (
	...
	versioned "github.com/zhouzhihu/k8s-example-crd/pkg/client/clientset/versioned"
	internalinterfaces "github.com/zhouzhihu/k8s-example-crd/pkg/client/informers/externalversions/internalinterfaces"
	v1beta1 "github.com/zhouzhihu/k8s-example-crd/pkg/client/listers/example/v1beta1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.ExampleV1beta1().Canaries(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ExampleV1beta1().Canaries(namespace).Watch(context.TODO(), options)
			},
		},
		&examplev1beta1.Canary{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *canaryInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&examplev1beta1.Canary{}, f.defaultInformer)
}
